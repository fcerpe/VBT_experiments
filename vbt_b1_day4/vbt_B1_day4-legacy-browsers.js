...
let expName = 'vbt_B1_day4';  // from the Builder filename that created this script
let expInfo = {
    'ID': '',
};
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'images/br_getucht.png', 'path': 'images/br_getucht.png'},
    ...
    {'name': 'images/br_bruin.png', 'path': 'images/br_bruin.png'},
    {'name': 'images/br_klimmen.png', 'path': 'images/br_klimmen.png'},
    {'name': 'images/br_pijnlijk.png', 'path': 'images/br_pijnlijk.png'},
    ...
    {'name': 'images/br_eerst.png', 'path': 'images/br_eerst.png'},
    {'name': 'images/br_paalbaak.png', 'path': 'images/br_paalbaak.png'},
    ...
    {'name': 'images/br_opkicht.png', 'path': 'images/br_opkicht.png'},
    ...
    {'name': 'images/br_gijf.png', 'path': 'images/br_gijf.png'},
    ...
    {'name': 'images/br_haza.png', 'path': 'images/br_haza.png'},
    ...
    {'name': 'images/br_dozijn.png', 'path': 'images/br_dozijn.png'},
    ...
    {'name': 'images/br_schenden.png', 'path': 'images/br_schenden.png'},
    ...
    {'name': 'images/br_wozing.png', 'path': 'images/br_wozing.png'},
    ...
    {'name': 'images/br_sulbon.png', 'path': 'images/br_sulbon.png'},
    {'name': 'images/br_maling.png', 'path': 'images/br_maling.png'},
    {'name': 'images/br_aflopen.png', 'path': 'images/br_aflopen.png'},
    {'name': 'images/br_aanzwaag.png', 'path': 'images/br_aanzwaag.png'},
    {'name': 'images/br_woede.png', 'path': 'images/br_woede.png'},
    {'name': 'images/br_toevol.png', 'path': 'images/br_toevol.png'},
    {'name': 'images/br_snee.png', 'path': 'images/br_snee.png'},
    {'name': 'images/br_mand.png', 'path': 'images/br_mand.png'},
    {'name': 'images/br_ezel.png', 'path': 'images/br_ezel.png'},
    {'name': 'images/br_joggen.png', 'path': 'images/br_joggen.png'},
    {'name': 'images/br_gebog.png', 'path': 'images/br_gebog.png'},
    {'name': 'images/br_zwek.png', 'path': 'images/br_zwek.png'},
    ...
    {'name': 'images/br_tucket.png', 'path': 'images/br_tucket.png'},
    {'name': 'images/br_kring.png', 'path': 'images/br_kring.png'},
    {'name': 'images/br_taal.png', 'path': 'images/br_taal.png'},
    {'name': 'images/br_lappen.png', 'path': 'images/br_lappen.png'},
    ...
    {'name': 'images/br_pittig.png', 'path': 'images/br_pittig.png'},
    {'name': 'images/br_noodzaak.png', 'path': 'images/br_noodzaak.png'},
    {'name': 'images/br_opruimen.png', 'path': 'images/br_opruimen.png'},
    {'name': 'images/br_heengaan.png', 'path': 'images/br_heengaan.png'},
    {'name': 'images/br_broodje.png', 'path': 'images/br_broodje.png'},
    ...
    {'name': 'images/br_strok.png', 'path': 'images/br_strok.png'},
    ...
    {'name': 'images/br_gaaf.png', 'path': 'images/br_gaaf.png'},
    ...
    {'name': 'images/br_zaalrijk.png', 'path': 'images/br_zaalrijk.png'},
    {'name': 'images/br_drummer.png', 'path': 'images/br_drummer.png'},
    {'name': 'images/br_flippen.png', 'path': 'images/br_flippen.png'},
    ...
    {'name': 'images/br_gaan.png', 'path': 'images/br_gaan.png'},
    ...
    {'name': 'images/br_fran.png', 'path': 'images/br_fran.png'},
    ...
    {'name': 'images/br_bisschap.png', 'path': 'images/br_bisschap.png'},
    ...
    {'name': 'images/br_steen.png', 'path': 'images/br_steen.png'},
    ...
    {'name': 'images/br_drooien.png', 'path': 'images/br_drooien.png'},
    {'name': 'images/br_seizoon.png', 'path': 'images/br_seizoon.png'},
    {'name': 'images/br_schotel.png', 'path': 'images/br_schotel.png'},
    ...
    {'name': 'images/br_midden.png', 'path': 'images/br_midden.png'},
    ...
    {'name': 'images/br_dalen.png', 'path': 'images/br_dalen.png'},
...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + ((("sub-" + expInfo["ID"]) + "_ses-004_task-training_script-BR_date-") + expInfo["date"]));
  ...
  psychoJS.setRedirectUrls(('https://psykuleuven.sona-systems.com/webstudy_credit.aspx?experiment_id=1768&credit_token=689872cfb6784b8c96a7f60544299e5e&survey_code=' + expInfo['participant']), '');
