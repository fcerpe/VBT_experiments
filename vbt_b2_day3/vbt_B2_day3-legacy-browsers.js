...
let expName = 'vbt_B2_day3';  // from the Builder filename that created this script
let expInfo = {
    'ID': '',
};
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'images/cb_sultan.png', 'path': 'images/cb_sultan.png'},
    ...
    {'name': 'images/cb_vlager.png', 'path': 'images/cb_vlager.png'},
    {'name': 'images/cb_booien.png', 'path': 'images/cb_booien.png'},
    {'name': 'images/cb_knie.png', 'path': 'images/cb_knie.png'},
    {'name': 'images/cb_strekken.png', 'path': 'images/cb_strekken.png'},
    {'name': 'images/cb_begrip.png', 'path': 'images/cb_begrip.png'},
    ...
    {'name': 'images/cb_uviek.png', 'path': 'images/cb_uviek.png'},
    ...
    {'name': 'images/cb_uniek.png', 'path': 'images/cb_uniek.png'},
    ...
    {'name': 'images/cb_sluier.png', 'path': 'images/cb_sluier.png'},
    {'name': 'images/cb_verraden.png', 'path': 'images/cb_verraden.png'},
    ...
    {'name': 'images/cb_eens.png', 'path': 'images/cb_eens.png'},
    ...
    {'name': 'images/cb_opzetten.png', 'path': 'images/cb_opzetten.png'},
    ...
    {'name': 'images/cb_gout.png', 'path': 'images/cb_gout.png'},
    ...
    {'name': 'images/cb_stikken.png', 'path': 'images/cb_stikken.png'},
    ...
    {'name': 'images/cb_alsof.png', 'path': 'images/cb_alsof.png'},
    {'name': 'images/cb_leek.png', 'path': 'images/cb_leek.png'},
    {'name': 'images/cb_beslag.png', 'path': 'images/cb_beslag.png'},
    {'name': 'images/cb_kaal.png', 'path': 'images/cb_kaal.png'},
    {'name': 'images/cb_croo.png', 'path': 'images/cb_croo.png'},
    {'name': 'images/cb_lukken.png', 'path': 'images/cb_lukken.png'},
    {'name': 'images/cb_kwaas.png', 'path': 'images/cb_kwaas.png'},
    {'name': 'images/cb_stallen.png', 'path': 'images/cb_stallen.png'},
    {'name': 'images/cb_kleren.png', 'path': 'images/cb_kleren.png'},
    {'name': 'images/cb_woning.png', 'path': 'images/cb_woning.png'},
    {'name': 'images/cb_kest.png', 'path': 'images/cb_kest.png'},
    ...
    {'name': 'images/cb_dwang.png', 'path': 'images/cb_dwang.png'},
    ...
    {'name': 'images/cb_gebod.png', 'path': 'images/cb_gebod.png'},
    {'name': 'images/cb_twaaf.png', 'path': 'images/cb_twaaf.png'},
    ...
    {'name': 'images/cb_onrecht.png', 'path': 'images/cb_onrecht.png'},
    ...
    {'name': 'images/cb_afbopen.png', 'path': 'images/cb_afbopen.png'},
    ...
    {'name': 'images/cb_zone.png', 'path': 'images/cb_zone.png'},
    {'name': 'images/cb_plek.png', 'path': 'images/cb_plek.png'},
    {'name': 'images/cb_mugeek.png', 'path': 'images/cb_mugeek.png'},
    ...
    {'name': 'images/cb_brappen.png', 'path': 'images/cb_brappen.png'},
    ...
    {'name': 'images/cb_verwoor.png', 'path': 'images/cb_verwoor.png'},
    ...
    {'name': 'images/cb_kaas.png', 'path': 'images/cb_kaas.png'},
    {'name': 'images/cb_invallen.png', 'path': 'images/cb_invallen.png'},
    ...
    {'name': 'images/cb_theeting.png', 'path': 'images/cb_theeting.png'},
    ...
    {'name': 'images/cb_makieren.png', 'path': 'images/cb_makieren.png'},
    {'name': 'images/cb_attentie.png', 'path': 'images/cb_attentie.png'},
    {'name': 'images/cb_hint.png', 'path': 'images/cb_hint.png'},
    ...
    {'name': 'images/cb_jongelui.png', 'path': 'images/cb_jongelui.png'},
    {'name': 'images/cb_traag.png', 'path': 'images/cb_traag.png'},
    {'name': 'images/cb_redding.png', 'path': 'images/cb_redding.png'},
    {'name': 'images/cb_schodel.png', 'path': 'images/cb_schodel.png'},
    ...
    {'name': 'images/cb_glijden.png', 'path': 'images/cb_glijden.png'},
    ...
    {'name': 'images/cb_hust.png', 'path': 'images/cb_hust.png'},
    ...
    {'name': 'images/cb_leemaken.png', 'path': 'images/cb_leemaken.png'},
    {'name': 'images/cb_waarbij.png', 'path': 'images/cb_waarbij.png'},
    {'name': 'images/cb_steel.png', 'path': 'images/cb_steel.png'},
    {'name': 'images/cb_bevret.png', 'path': 'images/cb_bevret.png'},
    {'name': 'images/cb_snuiven.png', 'path': 'images/cb_snuiven.png'},
    {'name': 'images/cb_paken.png', 'path': 'images/cb_paken.png'},
    ...
    {'name': 'images/cb_leugeren.png', 'path': 'images/cb_leugeren.png'},
...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + ((("sub-" + expInfo["ID"]) + "_ses-003_task-training_script-CB_date-") + expInfo["date"]));
  ...
  psychoJS.setRedirectUrls(('https://psykuleuven.sona-systems.com/webstudy_credit.aspx?experiment_id=1771&credit_token=e933b2841ed84a3a943057fe5b091425&survey_code=' + expInfo['participant']), '');
